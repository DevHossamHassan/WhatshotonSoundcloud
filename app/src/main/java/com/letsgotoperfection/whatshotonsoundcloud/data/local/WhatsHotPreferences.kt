...
abstract class WhatsHotPreferences {
    ...
    private val prefs: SharedPreferences by lazy {
        val co: Context = context!!.get()
                ?: throw IllegalStateException("Context was not initialized." +
    ...
    inner class StringPrefDelegate(prefKey: String? = null, val defaultValue: String?)
        ...
        override fun getValue(thisRef: Any?, property: KProperty<*>)
                : String? = prefs.getString(prefKey ?: property.name, defaultValue)
    ...
    inner class StringSetPrefDelegate(prefKey: String? = null, val defaultValue: Set<String>)
        ...
        override fun getValue(thisRef: Any?, property: KProperty<*>): Set<String> = prefs.getStringSet(prefKey
                ?: property.name, defaultValue)
